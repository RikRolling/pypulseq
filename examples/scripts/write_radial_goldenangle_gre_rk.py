...
Half spoke, delta ~ 137.51 degrees

Full Spoke, delta ~ 111.25 degrees
"""
...
def main(plot: bool = False, write_seq: bool = False, seq_filename: str = 'gre_8halfspoke_radial_golden_angle_pypulseq.seq'):
    # ======
    # SETUP
    # ======
    ...
    Nr = 8 #initial val = 60  # Number of radial spokes
